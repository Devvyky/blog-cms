      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index.php?Page=1">Home <i class="fa fa-home"></i></a></li>
            <li><a href="blog.php?Page=1">Blog <i class="fa fa-globe"></i></a></li>
            <li><a href="#">Services <i class="fas fa-users"></i></a></li>
...
//Query For When Category Is Active
      ...
      <div class="blogpost thumbnail">
        ...
        <div class="caption">
          <h1 id="heading" class=""><?php echo htmlentities($Title); ?></h1>
...
<a href="https://cutadlink.com/Vyky" target="_blank"><img src="//cutadlink.com/banner.png" title="Make short links and earn the biggest money" /></a>
